...
class ClienteRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'clie_nro_documento' => 'required|string|max:12|unique:clientes,clie_nro_documento,' . $clienteId . ',clie_id',
    ...
    public function messages()
    {
        return [
            ...
            'clie_nro_documento.max' => 'El campo Número de Documento no debe exceder los 12 caracteres.',
